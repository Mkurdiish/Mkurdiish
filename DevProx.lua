...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙يازباله ممنوع تبي كف؟")
end end
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or '[جلبريك]')
local DevProxTEAM = {"لتكول بوت اهينك والله اسمي "," 😒🔪","اسمي جلبريك "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"}
...
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
local DevProxTEAM = { "ضف وجهك @"..username.." ايا اهبل خفف غبائك","يا اهبل خفف غبائك @"..username.." خفف معدل الغباء لو سمحت غبائك عالي","حبيبي @"..username.." ياخي انت وين مخك تحب تنهان شو","دمشي لك @"..username.." ارحل يافاشل","هها ابو راس مثلث شفيك @"..username.." ماتعب نفسي معاه ذا اهبل",}
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ @JJNN1', 1, 'html')    
end 
--     Source IOS Jailbreak     --
if Sudo(msg) then 
