------------------------------------------------
-- This Source Was Developed By (IOS) @alone_kurdish,@Heizenberg1,@JJNN1,@Filza_507.--
--   This Is The Source Channel  .   --
--                - IOS JAILBREAK -                 --
--        -- https://t.me/tweakjailbreak --         --
------------------------------------------------
redis = require('redis') 
...
Load_DevProx() 
print("\27[36m"..[[
|This Source Was Developed By (MUSTAFA)
@alone_kurdish
@Heizenberg1
@JJNN1
@Filza_507.|
...
SudoIds = {Config.SudoIds,1360161611} or {Config.sudo_users,1360161611}
DevProx = Config.DevProx or Config.bot_id
TokenBot = Config.TokenBot or Config.token
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'جلبريك')
--     Source IOS Jailbreak     --
...
EditMsg(Chat_Id2, Msg_Id2, "⌁︙لا استطيع طرد اسيادي المجموعه")
return false  
end
...
local Sudo_Welcome = '⌁︙مرحبا عمي المطور \n⌁︙انت المطور الاساسي هنا \n⌁︙اليك ازرار سورس مصطفى \n⌁︙تستطيع تحكم فيني تحكم كامل من هنا سيدي وعمي المطور'
local key = {
{'اهلا سيدي مطور البوت ومن هنا تقدر تتحكم فيني'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌁︙اهلا بك مجددا عمي المطور \n⌁︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس مصطفى فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
Start_Source = "⌁︙مرحبا انا بوت مصطفى اسمي جلبريك "..NameBot.."\n⌁︙اختصاصي حماية المجموعات\n⌁︙من السبام والنشر والبيع والخ... ،\n⌁︙ فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل⌁︙سيتم رفع الادمنيه تلقائيا"
end 
...
Start_Source = "⌁︙اهلا بك في بوت مصطفى"..NameBot.."\n⌁︙اختصاصي حماية المجموعات\n⌁︙من التفليش والسبام والخخ .. . ،\n⌁︙تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل\n⌁︙سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم تفعيلي مسبقا', 1, 'md')
else
...
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙حصل ياسيدي "..dp.title_)
...
--     Source IOS Jailbreak     --
if text and (text:match("طيز") or text:match("ديس") or text:match("انيج") or text:match("نيج") or text:match("ديوس") or text:match("عير") or text:match("كسختك") or 
text:match("قحبه") or 
text:match("انيك") or 
text:match("كسمك") or text:match("كسربك") or text:match("بلاع") or text:match("ابو العيوره") or text:match("منيوج") or text:match("كحبه") or 
text:match("كحاب") or text:match("الكحبه") or text:match("كسك") or text:match("طيزك") or text:match("كس امك") or text:match("صرم") or text:match("كس اختك")) then
if not DevAbs:get(DevProx.."Abs:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙يازباله ممنوع تسب تبي كف؟")
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙ممنوع تتكلم فارسي او ترسل كلاوات")
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙خرا بيك ولك عار شبيك تسب الله ")
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙ممنوع تصير مطي هنا بقروبنا")
end end
--     Source IOS Jailbreak     --
if SecondSudo(msg) then
...
local BotName = (DevAbs:get(DevProx.."Abs:NameBot") or 'جلبريك')
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or '[جلبريك]')
local DevProxTEAM = {"لتكول بوت اهينك والله اسمي جلبريك"," 😒🔪","اسمي  "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"}
DevAbs2 = math.random(#DevProxTEAM) 
Dev_Abs(msg.chat_id_, msg.id_, 1, DevProxTEAM[DevAbs2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'جلبريك تندك بيا اهينك')
local DevProxTEAM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
DevAbs2 = math.random(#DevProxTEAM) 
Dev_Abs(msg.chat_id_, msg.id_, 1, DevProxTEAM[DevAbs2] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(DevProx..'Abs:NameBot') or 'جلبريك') then
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'جلبريك')
local namebot = {'😸♥️ تفضل ياحلو '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'}
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(DevProx..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم سيدي', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(DevProx..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم سيدي', 1, 'md') end
--     Source IOS Jailbreak     --
...
if not DevAbs:get(DevProx..'Abs:Lock:Games'..msg.chat_id_) then
DevAbs2 = {'النيل','14','الفم','11','30','بوتين','ستيف جوبر','باريس','10','النمل','حرف الواو','الشعر','','الكسندر غراهام بيل ','سحاب','الاسم','ذهب','حرف الام','العزائم','انسات','المنجنيق','اسيا','6','الاسد','مهر','الدولفين','اوروبا','الزئبق','لندن','الانسان','طوكيو','خديجه',}
name = DevAbs2[math.random(#DevAbs2)]
...
name = string.gsub(name,'البحر العربي','⌁︙ما هو البحر الذي يسمى بحر القلزم؟؟\n1- البحر العربي\n2- بحر القزوين\n3- البحر الاحمر')
...
⌁︙نقاطي • بيع نقاطي
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/tweakjailbreak)
]], 1, 'md')
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙عذرا الالعاب تم بعصها في المجموعه', 1, 'md')
end
end
--     Source IOS Jailbreak     --
if text == 'بيع نقاطي' and ChCheck(msg) then
if tonumber((DevAbs:get(DevProx..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌁︙نصاب تريد تبيع مامعاك نقاط\n⌁︙ارسل ↫ الالعاب للعب', 1, 'md')
else
...
local text =  [[
⦑ اهلا بك في السورس مصطفى ❤️ ⦒ 
┄─┅══┅─┄
👨🏻‍💻 . [Channel](http://t.me/tweakjailbreak)

🧔‍💻. [DEVELOPER](http://t.me/Filza_507)

🧔🏻 . [DEVELOPER](http://t.me/alone_kurdish)

🧔🏻 . [Assistant](http://t.me/iH7SaN)

📨 . [Groub Chat](http://t.me/iOSSSJailbreak)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]]
Dev_Abs(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
--     Source IOS Jailbreak     --
if Admin(msg) then
if text == "تاق للكل" and ChCheck(msg) then
function TagAll(dp1,dp2)
local text = "⌁︙وينكم يالربع ودي بجمعتكم \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
i = 0
...
Dev_Abs(msg.chat_id_, msg.id_, 1, 'ياخرا مسوي ذكي ها', 1, 'md')
return false 
end  
if tonumber(result.id_) == tonumber(DevId) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'ورع لاتندك بسيادك', 1, 'md')
return false  
end  
if tonumber(result.id_) == tonumber(1360161611) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'ماتعب نفسي معاه ذا اهبل', 1, 'md')
return false  
end  
if DevAbs:sismember(DevProx.."Abs:AbsConstructor:"..msg.chat_id_,result.id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, 'يا اهبل خفف غبائك', 1, 'md')
return false
end 
local DevProxTEAM = "صارر سيدي 🏃🏻‍♂️♥️"
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
local DevProxTEAM = { "ضف وجهك  ايا اهبل خفف غبائك","يا اهبل خفف غبائك  خفف معدل الغباء لو سمحت غبائك عالي","حبيبي  ياخي انت وين مخك تحب تنهان شو","دمشي لك  ارحل يافاشل","هها ابو راس مثلث شفيك  ماتعب نفسي معاه ذا اهبل",}
...
Dev_Abs(msg.chat_id_, msg.id_, 1, 'مسوي ذكي ابو راس مثلث اهبل', 1, 'md')
return false  
end  
if tonumber(result.sender_user_id_) == tonumber(DevId) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, 'حبيبي خفف معدل الغباء عندك ترا مره غبي عيب عليك', 1, 'md')
return false
end 
if tonumber(result.sender_user_id_) == tonumber(1360161611) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, 'تغلط على اعمامك احفرلك بالكاع قبرك', 1, 'md')
return false
end 
if DevAbs:sismember(DevProx.."Abs:AbsConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دزمهااا ياخول', 1, 'md')
return false
end 
local DevProxTEAM = "صارر سيدي 🏃🏻‍♂️♥️"
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
...
if tonumber(result.sender_user_id_) == tonumber(DevId) then  
Dev_Abs(msg.chat_id_, result.id_, 1, 'تعال مطوري محتاجك خاص تحدث ملفاتي 🏃🏻‍♂️♥️', 1, 'html')
return false
end 
local DevProxTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
...
if tonumber(result.id_) == tonumber(DevId) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'تعال مطوري محتاجك خاص حدث ملفاتي 🏃🏻‍♂️♥️ @'..username, 1, 'html')
return false  
end  
local DevProxTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙لاتستطيع تنزيل عمك مصطفى", 1, 'md')
return false 
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙وحش جديد ينضم للساحه")
end 
...
ReplyStatus(msg,result.id_,"Reply","⌁︙وحش جديد ينضم للساحه")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","⌁︙وحش جديد ينضم للساحه")
end
--     Source IOS Jailbreak     --
--     Rem SecondSudo     --
...
DevAbs:srem(DevProx..'Abs:SecondSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙صار استاذي")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
if result.id_ then
DevAbs:srem(DevProx..'Abs:SecondSudo:',result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙صار استاذي")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙صار استاذي")
end end
--     Source IOS Jailbreak     --
--       Set SudoBot      --
if SecondSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙ضبطني بملفات جديده حبي لا تنساني")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
...
ReplyStatus(msg,result.id_,"Reply","⌁︙ضبطني بملفات جديده حبي لا تنساني")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙ضبطني بملفات جديده حبي لا تنساني")
end
--     Source IOS Jailbreak     --
--       Rem SudoBot      --
...
function prom_reply(extra, result, success)
DevAbs:srem(DevProx..'Abs:SudoBot:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙خساره خسرنا واحد عزيز وغالي")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevAbs:srem(DevProx..'Abs:SudoBot:',result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙خساره خسرنا واحد عزيز وغالي")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙خساره خسرنا واحد عزيز وغالي")
end end
--     Source IOS Jailbreak     --
--      Set ManagerAll    --
if SudoBot(msg) then
...
ReplyStatus(msg,result.id_,"Reply","⌁︙تم حبيب قلبي")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙تم حبيب قلبي")
end
--     Source IOS Jailbreak     --
...
function prom_reply(extra, result, success)
DevAbs:srem(DevProx..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙منو قالك تلعب مع استاذي")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevAbs:srem(DevProx..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙منو قالك تلعب مع استاذي")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙منو قالك تلعب مع استاذي")
end end
if text ==('رفع منشئ اساسي') and not AbsConstructor(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙هذا الامر لعمك منشئ المجموعه او عمك المطور', 1, 'md')
end
--     Source IOS Jailbreak     --
--    Set  Constructor    --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙تم صار سيدي")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","⌁︙تم صار سيدي")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
function prom_reply(extra, result, success)
DevAbs:srem(DevProx..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙ابلع ولاك تم تنزيلك")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevAbs:srem(DevProx..'Abs:Constructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙ابلع ولاك تم تنزيلك")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙ابلع ولاك تم تنزيلك")
end 
end
--     Source IOS Jailbreak     --
--      Set Manager       --
...
DevAbs:sadd(DevProx..'Abs:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙ماتستاهل بس يله مبروك")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevAbs:sadd(DevProx..'Abs:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙ماتستاهل بس يله مبروك")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","⌁︙ماتستاهل بس يله مبروك")
end
--     Source IOS Jailbreak     --
--        Rem admin       --
...
DevAbs:sadd(DevProx..'Abs:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙مدري وش شايف فيك يرفعك بس يله")
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
DevAbs:sadd(DevProx..'Abs:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","⌁︙مدري وش شايف فيك يرفعك بس يله")
else 
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
send(msg.chat_id_, msg.id_,'⌁︙لقد تم تعطيل الكتم والتقييد من قبل المنشئين')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙مسوي خوي؟ ذي للمطورين اعمامك بس ', 1, 'md')
else
local List = DevAbs:smembers(DevProx.."Abs:Groups")
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙ناوي علي شي خبيث صح بس ابشر ماقدر اقول لا")
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙شبيك تقفل لغتك مصروع ولاك لكن ابشر")
...
if DevAbs:get(DevProx..'Abs:Lock:Text'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم استاذي")
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ فلزا و جوكر', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ فلزا و مصطفى', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جوكر', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ قماشه', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ معجون او برلين', 1, 'md')
end
end
...
{{text = '⌁ Tweak Jailbreak .',url="t.me/tweakjailbreak"}},
}
...
if not SudoBot(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙لاعمامك المطورين فقط', 1, 'md')
else
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/tweakjailbreak' end
...
if not SecondSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, 'لعمك المطور الاساسي فقط', 1, 'md')
else 
...
if not SecondSudo(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙لعمك مطور اساسي فقط', 1, 'md')
else 
...
if DevAbs:sismember(DevProx..'Abs:Groups',msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙المجموعه بالتاكيد مفعله سيدي', 1, 'md')
else
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙انا معطل اصلا حجي', 1, 'md')
else
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙اصلا ماعجبني قروبكم من اول "..dp.title_)
DevAbs:srem(DevProx.."Abs:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
local text = "⌁︙Source IOS Jailbreak\n⌁︙File Bot Groups\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
...
if not Admin(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙هذا الامر يخص اعمامك فقط\n⌁︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
...
if not SudoBot(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙هذا الامر مايخصك بس للمطورين يازعطوط', 1, 'md')
else
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس مصطفى', 1, 'md') 
os.execute('rm -rf DevProx.lua') 
os.execute('wget https://raw.githubusercontent.com/Mkurdiish/DevProx/master/DevProx.lua') 
dofile('DevProx.lua') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌁︙تم تحديث ملفات البوت سيدي خدمه ثانيه اامرني؟", 1, "md")
end 
...
if text == "متجر الملفات" or text == 'الملفات' then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Mkurdiish/DevProxFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌁︙قائمة ملفات متجر سورس المطور مصطفى\n⌁︙الملفات المتوفره حاليا ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/MKurdiish/DevProxFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ @tweakjailbreak', 1, 'html')    
end 
--     Source IOS Jailbreak     --
if Sudo(msg) then 
...
------------------------------------------------
-- This Source Was Developed By (MUSTAFA) @iH7SaN.--
--   This Is The Source Channel @JJNN1 | @Filza_507.   --
--                - TweakJailbrak -                 --
--        -- https://t.me/tweakjailbreak --         --
------------------------------------------------ 
