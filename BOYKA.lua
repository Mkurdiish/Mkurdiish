...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Mkurdiish/Files_Boyka/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1360161611) then
var = true  
...
os.execute('wget https://raw.githubusercontent.com/Mkurdiish/Mkurdiish/master/BOYKA.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس مصطفى\n ❃∫ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس مصطفى \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/tweakjailbreak) \n ❃∫ [قناه السورس](t.me/Tweakjailbreak)')
end
...
"هاها شو غيرت معرفك بس لا هددتك الحب",
...
┄─┅══┅─┄
  ...
  👨🏻‍💻 . [Channel](t.me/tweakjailbreak)  
  
  🧔🏻 . [DEVELOPER](t.me/alone_kurdish)       
   
  📨 . [Groub Chat](t.me/iOSSSJailbreak) 
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Mkurdiish/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات مصطفى\n ❃∫ ملفات السورس ↓\n≪━━━━━━MK━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━MK━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس مصطفى ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/Tweakjailbreak) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Mkurdiish/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس مصطفى \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جلبريك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جلبريك')
local BOYKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مصطفى').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'مصطفى')
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━MK━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[Tweak 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/tweakjailbreak)➢ ')
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مابوس ولي😌😹","خدك نضيف 😂","البوسه بالف حمبي 🌝💋","خلي يزحفلي وابوسه 🙊😻","كل شويه ابوسه كافي 😏","ماابوسه والله هذا زاحف🦎","محح هاي لحاته صاكه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مصطفى')
